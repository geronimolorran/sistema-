...
<body>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td>
                <a href="visualizar_vale.php?id=<?php echo $vale['id_vale']; ?>">Visualizar</a>
                <a href="editar_vale.php?id=<?php echo $vale['id_vale']; ?>">Editar</a>
                <a href="deletar_vale.php?id=<?php echo $vale['id_vale']; ?>">Deletar</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </table>
